...
class CNN(nn.Module):
	...
	def forward(self, input_sentences, batch_size=None):
		...
		"""
		text_input = self.word_embeddings(input_sentences)
		# input.size() = (batch_size, num_seq, embedding_length)
		text_input = text_input.unsqueeze(1)
		# input.size() = (batch_size, 1, num_seq, embedding_length)
		
		max_out1 = self.conv_block(text_input, self.conv1)
		max_out2 = self.conv_block(text_input, self.conv2)
		max_out3 = self.conv_block(text_input, self.conv3)
